...
#define PACKAGE_STRING "WindowMaker 0.96.0"
...
/* defined when the pango library is used in WINGs */
#define USE_PANGO 1
...
/* defined when valid XRes library with header was found */
/* #undef USE_XRES */
...
#define WLIB_CONSTRUCTOR(func_name) __attribute__ ((constructor)) func_name
